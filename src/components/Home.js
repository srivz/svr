        ...
        <Row>
          <Col className="about-us-text2">
            ...
            <p className="about-us-heading2-content">
              SV&R Partners is a sleek new age law firm founded by dedicated and
              experienced advocates with exposure to global best practices. SV&R
              Partners is formed by the merger of S and V Law Offices and
              Rajasekaran Associates. Before the merger, for over 20 years the
              merged firms each have represented a diverse list of clients from
              Fortune 500 companies to highly innovative startups, and small and
              medium enterprises; govern-ments to some of the World’s best
              educational institutes, and an elite list of private clients. The
              founding partners have cumulative experience of more than 75 years
              at the Bar, appearing before every legal fora from the district
              Court to the Supreme Court; from the Patent Office to the Company
              Law Appellate Tribunal. It is our single-minded focus to set a new
              benchmark in terms of quality, service excellence and
              responsiveness in satisfying the diversified needs of our clients
              in the most cost-effective and efficient manner as possible.
            </p>
          </Col>
            ...
            <Col className="about-us-text3">
              ...
              <p className="about-us-heading3-content">
                <ul>
                  ...
                  <li>
                    {" "}
                    100% quality check minimizing errors to zero every time, all
                    the time
                  </li>
          ...
          <Row>
            <Col className="about-us-text4">
              <p className="about-us-heading4-content">
                ...
                Intellectual Property practice as its core focus areas. The firm
                also offers legal services in Media, Entertainment and
                Technology Law, Regulatory Affairs, and Dispute Resolution. The
                firm is based out of Chennai, India with satellite office in
                Dubai.
              </p>
            </Col>
        ...
        <Container>
          <Row className="about-us-news">
            ...
            <Col className="about-us-news-heading-right">
              ...
              <span className="about-us-news-heading-right-text">View all</span>
            </Col>
